...
*  `save_noise=false`: whether to return the NoiseProcess W generated while integrating the SDE (the output will take the form (t,ρ,W) instead of (t,ρ)).
        The times and values are accessible via `W.t`, `W.W`.
        To get the Wiener increments, use diff(W.W), not W.dW.
...
set `save_noise=true` to obtain a NoiseProcess object W with the times W.t and values W.W of the realization generated by the SDE integration.
"""
