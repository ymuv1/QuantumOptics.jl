...
sparse_eye(T, N::Int) = SparseMatrix(Int[N,N], Int[1:N;], Int[1:N;], ones(T, N))
sparse_eye(T, N1::Int, N2::Int) = (N = min(N1,N2); SparseMatrix(Int[N1,N2], Int[1:N;], Int[1:N;], ones(T, N)))
